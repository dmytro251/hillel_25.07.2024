...
if _number % 10 > 0:
    ...
    print(return_number)
elif _number % 10 == 0 and _number % 100 // 10 > 0:
    return_number=_number % 100 // 10 * 1000 +_number // 100 % 10 * 100 + _number // 1000 % 10 * 10 + _number // 10000
    print(f'{0}{return_number}')
elif _number % 10 == 0 and _number % 100 // 10 == 0 and _number // 100 % 10 > 0:
    return_number =_number // 100 % 10 * 100 + _number // 1000 % 10 * 10 + _number // 10000
    print(f'{0}{0}{return_number}')
elif _number % 10 == 0 and _number % 100 // 10 == 0 and _number // 100 % 10 == 0 and _number // 1000 % 10 > 0:
